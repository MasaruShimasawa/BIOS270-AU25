...
5. **Create a Branch for Your Task**
   ...
   ```
   - Create some changes in this `HW1.md`, for example, change this SUNetID to yours `masarus`
...
- Screenshot of PR link on Jira task
   ...
   <img width="1470" height="956" alt="Screenshot 2025-11-17 at 11 36 10 PM" src="https://github.com/user-attachments/assets/6cd1dbf5-4b91-4646-aeec-027e9a40ce61" />
